            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 mb-4">
                ...
                <div class="mt-4 flex items-center justify-start gap-4">
                    <a href="{{ route('dosen.profil.index') }}"
                        class="text-sm font-semibold text-gray-900 hover:border border-gray-900 rounded-md px-3 py-2">
                        Batal
                    </a>
                    <button type="submit"
                        class="bg-indigo-600 hover:bg-indigo-500 rounded-md px-4 py-2 min-w-[160px] text-sm font-semibold text-white shadow-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        Simpan Perubahan
                    </button>
                </div>
