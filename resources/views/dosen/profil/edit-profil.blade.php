...
<form method="POST" action="{{ route('dosen.profil.update', $user->id) }}" enctype="multipart/form-data">
    ...
    <div class="border-b border-gray-900/10 pb-12 p-6 bg-white border border-gray-200 rounded-lg">
        <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            {{-- NIDN (readonly) --}}
            <div class="sm:col-span-3">
                <label class="block text-sm font-medium text-gray-900">NIDN</label>
                <input type="text" value="{{ $user->dosenPembimbing->nidn }}" readonly
            ...
            <div class="sm:col-span-3">
                ...
                <input type="text" name="no_telp" id="no_telp" value="{{ old('no_telp', $user->dosenPembimbing->no_telp) }}"
                    class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:outline-indigo-600 sm:text-sm">
            </div>
            ...
            <div class="sm:col-span-3">
                ...
                <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $user->dosenPembimbing->jabatan) }}"
                    class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:outline-indigo-600 sm:text-sm">
            </div>
            ...
            <div class="sm:col-span-3">
                ...
                <input type="text" value="{{ $user->dosenPembimbing->prodi->nama }}" readonly
                    class="mt-2 block w-full bg-gray-100 px-3 py-1.5 rounded-md border border-gray-300 text-gray-700 sm:text-sm">
            </div>
